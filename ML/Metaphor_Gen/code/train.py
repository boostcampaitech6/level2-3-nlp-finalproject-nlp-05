...
class ModelArguments:
    ...
    setproc_model: str = field(
        default='google/mt5-large',
        metadata={"help": "process model name"}
    )
...
def main():
    ...
    setproctitle("monolingual_{}".format(model_args.setproc_model))
    ...
    dataset_columns = summarization_name_mapping.get('commongen', None)
